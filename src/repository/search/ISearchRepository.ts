import { SearchData, SearchResponse, SourceFile, SourceUIDs } from "../../model/search/types.domain"
...
export default interface ISearchRepository {
    ...
    sourcesWithTimestamps(): Promise<Dashboard<SourceUIDs[]>>
    sourceFiles(sourceIndex: string): Promise<Dashboard<SourceFile[]>>
    source(sourceIndex: string): Promise<Dashboard<SourceUIDs>>
}